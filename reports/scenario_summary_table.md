...
| S07 | `S07_cut_in_brake` | `emergency_response` | front-vehicle distance / TTC based emergency braking | `cut_in_detected`, `emergency_brake_started`, `safe_brake_completed`, `task_success` | 0 | `min_front_vehicle_distance ≈ 15.19 m`; `min_TTC ≈ 2.98 s`; `max_brake ≈ 0.80`; `success = true` | Completed |
