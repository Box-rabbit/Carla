...
DEFAULT_RESULTS_DIR = Path("audio")
...
DEFAULT_OUTPUT = Path("triggers/route_audio_matches.yaml")
...
ACTION_WINDOW_HINTS = {
    ...
    "overtake": {"OVERTAKE", "LANE_CHANGE_LEFT", "CHANGE_LEFT"},
    "slow_vehicle": {"OVERTAKE", "LANE_CHANGE_LEFT", "CHANGE_LEFT", "SLOW_DOWN"},
    "pedestrian": {"PEDESTRIAN_CAUTION", "SLOW_DOWN"},
    "crossing": {"PEDESTRIAN_CAUTION", "SLOW_DOWN"},
...
def _scenario_hint_from_path(path):
    """Infer the intended scenario from an audio/S11/... directory."""
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description="Match audio/**/*.wav voice commands to route/scenario events."
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "same action. Audio stored under audio/Sxx is always matched within "
    ...
    output = {
        "description": (
            ...
            "carla_eval/tools/match_route_audio.py after changing audio or annotations."
        ),
