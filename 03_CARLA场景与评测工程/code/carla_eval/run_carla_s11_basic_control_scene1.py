"""Entry point for S11 – PDF scene 1 basic-control 5km drive."""
...
from carla_eval.scenarios_impl import BasicControlScene1


_DEFAULT_CFG = (
    Path(__file__).resolve().parents[2]
    / "configs/scenarios/basic_control/S11_basic_control_scene1_5km.yaml"
)


def _parse_args(argv=None):
    p = argparse.ArgumentParser(description="S11 – PDF scene 1 basic-control 5km drive")
