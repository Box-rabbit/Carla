"""Entry point for S13 – PDF scene 3 extreme emergency 6km drive."""
...
from carla_eval.scenarios_impl import EmergencyResponseScene3


_DEFAULT_CFG = (
    Path(__file__).resolve().parents[2]
    / "configs/scenarios/emergency_response/S13_extreme_emergency_scene3_6km.yaml"
)


def _parse_args(argv=None):
    p = argparse.ArgumentParser(description="S13 – PDF scene 3 extreme emergency 6km drive")
    ...
    p.add_argument("--voice-match-config", default="triggers/route_audio_matches.yaml")
...
def main(argv=None):
    ...
    scenario = EmergencyResponseScene3()
