...
输出：evaluation_report.json、evaluation_report.csv、speed_curve.png、latency_curve.png、event_timeline.png、summary_report.json、summary_table.csv。
