"""Entry point for S07 – Cut-in emergency brake.

Usage:
    python -m carla_eval.run_carla_s07_cut_in_brake [--host HOST] [--port PORT]
"""
import argparse
import sys
...
from carla_eval.scenarios_impl import CutInBrake


_DEFAULT_CFG = Path(__file__).parent.parent / "configs/scenarios/emergency_response/S07_cut_in_brake.yaml"


def _parse_args(argv=None):
    p = argparse.ArgumentParser(description="S07 – cut-in brake")
